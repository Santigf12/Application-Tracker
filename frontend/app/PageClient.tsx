...
export default function PageClient() {
  ...
  const [appliedDateRange, setAppliedDateRange] = useState<[string | null, string | null]>([
    null,
    null,
  ]);
  ...
  return (
    <Row gutter={[16, 0]} style={{ minHeight: '100%' }}>
      <Col flex="auto">
        <Card variant="borderless" style={{ minHeight: 50, width: '100%', textAlign: 'center' }}>
              ...
              return {
                onClick: (event) => {
                  ...
                  if (!isInsideSelectionColumn) {
                    router.push(`/application/${record.id}?page=${currentPage}`);
                  }
                },
              };
            }}
