...
import { useCoverLetter, useSaveCoverLetter } from '@/lib/features/applications/hooks';
import { useCoverLetterFile } from '@/lib/features/files/hooks';
import { useGenerateCoverLetter } from '@/lib/features/tools/hooks';

export default function CoverModal({ open, onClose, posting, company, position, }: { open: boolean; onClose: () => void; posting: string; company: string; position: string; }) {
